...
import { EditorLinkPopover } from './components/editor-link-popover'

import { useTextmenuStates } from './hooks/useTextmenuStates'
import { useTextmenuCommands } from './hooks/useTextmenuCommands'
import { useTextmenuContentTypes } from './hooks/useTextmenuContentTypes'

// We memorize the button so each button is not re-rendered
  ...
  return (
    ...
    >
      <Toolbar.Wrapper>
        ...
        <EditorLinkPopover onSetLink={commands.onLink} />
        <Popover.Root>

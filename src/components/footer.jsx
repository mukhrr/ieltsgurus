...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-gray-100 py-2">
      <div className="container mx-auto flex flex-col-reverse items-center justify-between gap-2 px-4 sm:flex-row sm:gap-0">
        <p className="text-sm text-gray-500">&copy; 2024 IELTStify. All rights reserved.</p>
